                    ...
                    <div class="single-details">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade <?php echo $service == 'infrastructure' ? 'show  active' : ''; ?>" id="Infrastructure" role="tabpanel" aria-labelledby="infrastructure-tab">
                                <div class="details-wrap">
                                    <div class="details-thumb">
                                        <img loading="lazy" src=" ./img/berkett-imgs/services-expanded/little-digger-blue.jpg" alt="blue digger" style="max-width: 730px; height: 337px;">
                                    </div>
                                    <div class="details-info">
                            ...
                            <div class="tab-pane fade <?php echo $service == 'gravel' ? 'show  active' : ''; ?>" id="gravel" role="tabpanel" aria-labelledby="gravel-tab">
                                <div class="details-wrap">
                                    <div class="details-thumb">
                                        <img  loading="lazy" src="./img/berkett-imgs/services-expanded/gravel-roadjpg.jpg" alt="road side" style="max-width: 730px; height: 337px;">
                                    </div>
                                    <div class="details-info">
                                        <h3>Gravel & Quarry</h3>
                            ...
                            <div class="tab-pane fade  <?php echo $service == 'forestry' ? 'show  active' : ''; ?>" id="forestry" role="tabpanel" aria-labelledby="forestry-tab">
                                <div class="details-wrap">
                                    <div class="details-thumb">
                                        <img loading="lazy" src="./img/berkett-imgs/services-expanded/Skid 3 bench.jpg" alt="forestry skid site" style="max-width: 730px; height: 337px;">
                                    </div>
                                    <div class="details-info">
                                        <h3>Forestry</h3>
